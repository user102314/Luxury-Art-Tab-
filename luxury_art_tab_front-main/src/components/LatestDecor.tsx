      ...
      <div className="relative z-[1] mx-auto grid max-w-6xl items-center gap-10 md:grid-cols-[1.05fr_1fr] md:gap-14">
        <div>
          ...
          <h2 className="font-display text-3xl font-bold tracking-tight text-foreground md:text-4xl lg:text-5xl">
            Comment commander votre <em className="text-accent-orange">tableau mural</em>
          </h2>

          <p className="mt-5 max-w-xl text-sm leading-relaxed text-muted-foreground md:text-base">
            Choisissez l’œuvre, la dimension puis le cadre. Luxury Art_Tab prépare le tableau
            décoratif à l’atelier et l’expédie en Tunisie — sans changer le prix selon la couleur
            du cadre.
          </p>

          <p className="mt-4 max-w-xl text-sm leading-relaxed text-muted-foreground md:text-base">
            Besoin d’un format sur mesure ou d’un motif calligraphie, floral ou abstrait ?
            Écrivez-nous : nous confirmons le délai avant production.
          </p>
        ...
        <div className="relative">
          ...
          <div className="relative overflow-hidden rounded-3xl border border-foreground/10 bg-sand/40 p-2.5 shadow-[0_30px_60px_-25px_rgba(50,20,0,0.35)] backdrop-blur-sm">
            <img
              src={atelierProcess}
              alt="Atelier en Tunisie : finition d'un tableau décoratif avant livraison"
