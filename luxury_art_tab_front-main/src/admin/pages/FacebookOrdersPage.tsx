...
export default function FacebookOrdersPage() {
  ...
  const facebookOrders = useMemo(
    () =>
      filterSortOrders(
        orders.filter((o) => o.canal === 'FACEBOOK'),
  ...
  return (
    <div className="space-y-8">
      ...
      <ListToolbar
        ...
        searchPlaceholder="Rechercher client, n° commande, réf. Facebook…"
        sort={sort}
        ...
        resultCount={facebookOrders.length}
        totalCount={orders.filter((o) => o.canal === 'FACEBOOK').length}
        onReset={() => {
          setSearch('')
          setListStatut('ALL')
          setSort('date')
